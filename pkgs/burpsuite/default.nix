    ...
    if proEdition then
      {
        ...
        hash = "sha256-UqKHBfg7COE9x8QQQVqVsvlx0AlnJ/+IhbiHODfrnIA=";
      }
    else
      {
        productName = "community";
        productDesktop = "Burp Suite Community Edition";
        hash = "sha256-q3AfjOfgZCa7Magcl2D9Rngquvabkad6AJiMUxLYYJU=";
      };
...
buildFHSEnv {
  ...
  runScript = "${jdk}/bin/java -jar ${src} --disable-auto-update";
